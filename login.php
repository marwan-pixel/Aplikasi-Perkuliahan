...
<body>
    <div style="height: 100vh;" class=" row d-flex justify-content-center align-items-center bg-primary ">
        <div class="card col-sm-6">
            ...
            <div class="card-body">
                <form id="login">
                    <input hidden name="role" type="text" value="admin" id="">
                    <div class="mb-3">
                    ...
                    <div class="d-grid gap-2 col-6 mx-auto ">
                        <button type="button" class="my-3 btn btn-primary">Log In</button>
                    </div>
                </form>
